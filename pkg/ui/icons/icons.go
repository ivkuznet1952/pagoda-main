...
func Square() Node {
	return iconCalendar("Square",
		El("path",
			Attr("stroke-linecap", "round"),
			Attr("stroke-linejoin", "round"),
			Attr("d", "M 1 1 L 1 19 L 19 19 L 19 1 L 1 1 z M 2 2 L 18 2 L 18 18 L 2 18 L 2 2 z"),
		),
	)
}

func SquareRED(id string) Node {
	return iconCalendarRED("Square"+id,
		El("path",
			//Attr("stroke-linecap", "round"),
			//Attr("stroke-linejoin", "round"),
			Attr("fill", "#DD2E44"),
			//Attr("fill", "#008000"),
			Attr("d", "M36 32a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4v28z"),
		),
	)
}

func iconCalendarRED(id string, els ...Node) Node {
...
func SquareGreen(id string) Node {
	return iconCalendarRED("Square"+id,
		El("path",
			//Attr("stroke-linecap", "round"),
			//Attr("stroke-linejoin", "round"),
...
func iconCalendarGreen(id string, els ...Node) Node {
	return cache.SetIfNotExists(fmt.Sprintf("icon.%s", id), func() Node {
		return SVG(
			Attr("xmlns", "http://www.w3.org/2000/svg"),
			//Attr("fill", "#008000"),
...
func iconCalendar(id string, els ...Node) Node {
	return cache.SetIfNotExists(fmt.Sprintf("icon.%s", id), func() Node {
		return SVG(
			Attr("xmlns", "http://www.w3.org/2000/svg"),
			Attr("fill", "none"),
...
func IconRowPlus() Node {
	return iconCalendar("Plus",
		El("path",
			Attr("stroke-linecap", "round"),
			Attr("stroke-linejoin", "round"),
			Attr("d", "M12 4.5v15m7.5-7.5h-15"),
		),
	)
}

func IconRowMinus() Node {
	return iconCalendar("Minus",
		El("path",
			Attr("stroke-linecap", "round"),
			Attr("stroke-linejoin", "round"),
			Attr("d", "M5 12h14"),
...
func IconDelete() Node {
	return iconCalendar("Delete",
		El("path",
			Attr("stroke-linecap", "round"),
			Attr("stroke-linejoin", "round"),
			Attr("d", "m14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21q.512.078 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48 48 0 0 0-3.478-.397m-12 .562q.51-.088 1.022-.165m0 0a48 48 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a52 52 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a49 49 0 0 0-7.5 0"),
		),
	)
}
